...
export default function ClientLoginScreen({ navigation }) {
  ...
  const responsiveStyles = {
    ...
    logoInnerSize: isLandscape ? (isSmallDevice ? 40 : 48) : (isSmallDevice ? 58 : 60),
    titleSize: isLandscape ? 20 : (isSmallDevice ? 24 : (isLargeDevice ? 32 : 22)),
    subtitleSize: isLandscape ? 12 : (isSmallDevice ? 13 : (isLargeDevice ? 16 : 12)),
    ...
    <SafeAreaView style={[styles.safeArea, isLandscape && styles.safeAreaLandscape]}>
      ...
      <TouchableOpacity
        style={[
          ...
          { top: Platform.OS === 'android' ? StatusBar.currentHeight + responsiveStyles.backButtonTop : responsiveStyles.backButtonTop }
        ]}
      ...
      >
        <View style={[
          ...
          isSmallDevice && styles.backButtonCircleSmall,
          isLandscape && styles.backButtonCircleLandscape
        ]}>
          <Ionicons 
            name="arrow-back" 
            size={isSmallDevice ? 20 : (isLandscape ? 18 : 22)} 
            color="#2563eb" 
          />
        </View>
      </TouchableOpacity>
      ...
      <KeyboardAvoidingView
        ...
        keyboardVerticalOffset={Platform.OS === 'ios' ? (isLandscape ? 20 : 40) : 0}
      >
        <ScrollView
          ...
          <View style={[
            ...
            <View style={[
              ...
              <View style={[
                ...
                <View style={[
                  styles.logoOuter,
                  { width: responsiveStyles.logoSize, height: responsiveStyles.logoSize, borderRadius: responsiveStyles.logoSize / 2 }
                ]}>
                  <View style={[
                    styles.logoInner,
                    { 
                    ...
                    <Ionicons
                      name="briefcase"
                      size={isLandscape ? scale(24) : (isKeyboardVisible ? scale(28) : scale(28))}
                      color="#2563eb"
                    />
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  backButtonCircleSmall: {
    width: scale(40),
    height: scale(40),
    borderRadius: scale(25),
  },
  backButtonCircleLandscape: {
    width: scale(36),
    height: scale(36),
